  ...
  void _onEducationalLevelChanged(String? value) {
    setState(() {
      ...
      // CRITICAL: Reset the grade level when changing
      // education level to prevent errors.
  ...
  void _onGradeYearLevelChanged(String? value) {
    ...
    final List<Widget> _studentPages = [
      StudentPage1(
        ...
        gender: _gender, // Now passes the UPDATED value
    ...
    _pagesToShow = (widget.role == 'student') 
        ? _studentPages 
        : _teacherPages;
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                              currentPage < _pagesToShow.length - 1 ? 'Save and Continue' : 'Save and Finish',
